  ...
  return (
    <div className='feature'>
     ...
     <div className="info">
       ...
       <span className="desc">
         Lorem ipsum dolor sit amet consectetur adipisicing elit. Error neque cumque omnis deleniti eos, id, repudiandae iure enim necessitatibus fugiat odio, perferendis harum?
       </span>
